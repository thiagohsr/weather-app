...
export default async function handler(
  ...
  await fetch(
    ...
    console.error('Forecast API fail with');
  }).then(responseJson => {
...
// 
// `https://api.openweathermap.org/data/2.5/forecast?lat=${query?.lat}&lon=${query?.lon}&cnt=7&units=metric&appid=${process.env.NEXT_PUBLIC_WEATHER_API_KEY}`
// {
//   "cod": "200",
//   "message": 0,
//   "cnt": 40,
